/**
 * Run this script to generate `./scripts/withExtendedRecipe.json` from `src/items/items_auto_chess_zh-CN.json`
 * Format the file in vscode and compare two files before updating the source file.
 * - [ ] Run prettier against the JSON file.
 */
